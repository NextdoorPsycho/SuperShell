...
import 'package:super_shell/pages/login/page_login.dart';
...
class LoginService extends StatelessService {
  ...
  Future<void> signOutDialog(BuildContext context) => dialogConfirm(
      ...
      title: "Log Out?",
      description:
          "Are you sure you want to log out of your account? You will need to log in again before you can use the app again.",
  ...
  // IF YOU WANT A DESKTOP APP FOR WINDOWS, YOU NEED TO USE THIS METHOD
  // Replace these with your own Google Client ID and Redirect URI
  // Note you will get a bad redirect if you dont get it from GOOGLE, not firebase!
  // get it here: https://storage.googleapis.com/psycho_upload/ShareX/2024/05/msedge_F0ALaKtmb6.png
  // Use those redirect URL's and client id's NOT the ones on firebase!
