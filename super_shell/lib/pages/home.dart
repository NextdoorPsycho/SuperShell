...
import 'package:super_shell/prefabs/widgets/button.dart';
import 'package:super_shell/prefabs/widgets/text.dart';
  ...
  Widget buildContent(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        UMT.animated(context, SSText.p, const Duration(milliseconds: 100),
            'Change Everything'),
        const SizedBox(height: 40),
        SSButton.themeToggle(context),
        SSButton.signOut(context),
        const Expanded(flex: 1, child: SizedBox()),
      ],
    );
  }
